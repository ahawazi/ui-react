            ...
            <div className="w-full p-4">
                <div className="flex justify-end text-white items-center py-4 px-4">
                    ...
                    <div className="flex space-x-2 space-x-reverse px-2">
                        <img src="https://placehold.co/100x100" alt="logo" className="w-8 h-8"/>
                        <img src="https://placehold.co/100x100" alt="logo" className="w-8 h-8"/>
                        <img src="https://placehold.co/100x100" alt="logo" className="w-8 h-8"/>
                        <img src="https://placehold.co/100x100" alt="logo" className="w-8 h-8"/>
                ...
                <div className="bg-white rounded-3xl flex p-4 pl-12">
                    <div className="w-32 relative shrink-0">
                        <img src="https://placehold.co/600x400" alt="logo"
                             className="absolute -right-6 top-0 h-full w-full"/>
                    </div>
